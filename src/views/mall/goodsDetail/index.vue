        ...
        <el-main>
            <el-row>
                ...
                <el-col :span="12">
                    ...
                    <div
                        class="br5 pd10 mgt20"
                        style="background-color: #ddebfd"
                    >
                        <div class="goods-desc-margin">
                            <span class="span-wt-100">价格</span>
                            <span class="fs24 pdl10">
                                ￥{{ goods.price }}
                            </span>
                        </div>
                        <div class="goods-desc-margin mgt8">
                            <span class="span-wt-100">折扣</span>
                            <span class="fs16 pdl10">
                                {{ goods.discount }}
                            </span>
                        </div>
                    </div>

                    <div class="br5 pd10 mgt20">
                        <span class="span-wt-100">新旧程度</span>
                        <span class="fs16 pdl10">{{ goods.oldDegree }}</span>
                    </div>
                    <!-- <div class="goods-desc-margin">
                        交易方式：
                        <el-select
                    ...
                    <div class="br5 pd10 mgt20">
                        <span class="span-wt-100">销量</span>
                        <span class="fs16 pdl10">
                            {{ goods.historySales }}
                        </span>
                    </div>
                    ...
                    <div class="br5 pd10 mgt20">
                        <span class="span-wt-100">库存</span>
                        <span class="fs16 pdl10">
                            {{ goods.stockQuantity }}
                        </span>
                    </div>
                    ...
                    <div class="br5 pd10 mgt20">
                        <span class="span-wt-100">购买数量</span>
                        <span class="fs16 pdl10"
                            ><input
                                class="pdl10"
                                style="outline: 0; height: 30px"
                                v-model="buyCount"
                        /></span>
                    </div>
                    <div class="goods-desc-margin mgt20">
                        <el-button type="primary" @click="jump2pay"
                            >立即购买</el-button
                        >
                    </div>
                </el-col>
